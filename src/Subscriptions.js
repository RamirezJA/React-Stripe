      ...
      <AuthCheck fallback={<SignIn />}>
        ...
        <div className="well">
          ...
          <button
            className={
              'btn ' +
              (plan === 'price_1HHMllLWaRy4ENdFswQ82cXF'
                ? 'btn-primary'
                : 'btn-outline-primary')
            }
            onClick={() => setPlan('price_1HHMllLWaRy4ENdFswQ82cXF')}
          >
            Choose Monthly $25/m
          </button>
          ...
          <button
            className={
              'btn ' +
              (plan === 'price_1HHMllLWaRy4ENdF7PJ20jfN'
                ? 'btn-primary'
                : 'btn-outline-primary')
            }
            onClick={() => setPlan('price_1HHMllLWaRy4ENdF7PJ20jfN')}
          >
